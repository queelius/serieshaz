...
**dfr.dist.series** composes multiple `dfr_dist` objects into a series system distribution. A series system fails when *any* component fails, so the system hazard is the sum of component hazards:
